...
//    TLStatusCellViewController *mainController = [[TLStatusCellViewController alloc] init];
//    //KCContactTableViewController *mainController=[[KCContactTableViewController alloc]init];
//
   // TLContactTableViewController *mainController = [[TLContactTableViewController alloc] init];
    TLContactTableViewControllerWithUISearchDisplayController *mainController = [[TLContactTableViewControllerWithUISearchDisplayController alloc] init];
